...
public class CustomModifierLoaderTest {
    ...
    @Test public void testReadModifier() throws Exception {
        ...
        // assertThat(mod.skills.encouragedSkills(), allOf(
        //                (Matcher<? super Map<? extends Skill, ? extends Double>>) IsMapContaining.hasEntry((Skill) new Blowjob(player), 1.0),
        //                (Matcher<? super Map<? extends Skill, ? extends Double>>) IsMapContaining.hasEntry((Skill) new Kick(player), -2.0)));
