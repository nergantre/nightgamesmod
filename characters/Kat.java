...
public class Kat extends BasePersonality {
	...
	public Kat(){
		...
		this.character.getStamina().setMax(150);
	...
	public String victory(Combat c,Result flag) {
		...
		if(flag==Result.intercourse){
			opponent.add(new Horny(opponent, 5, 10, character.nameOrPossessivePronoun() + " pheromones"));
			...
			opponent.add(new Horny(opponent, 5, 10, character.nameOrPossessivePronoun() + " pheromones"));
			opponent.add(new Horny(opponent, 20, 5, character.nameOrPossessivePronoun() + " feral musk"));
	...
	public String intervene3p(Combat c, Character target, Character assist) {
		if(target.human()){
			...
			return "Your fight with "+target.name()+" goes back and forth for several minutes, leaving you both naked and aroused, but without a clear winner. You back off " +
					...
					"you footing and stumble backwards. "+target.name()+" advances to take advantage of your mistake, but she soon realizes you aren't looking at her, but " +
