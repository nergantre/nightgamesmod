    ...
    public void act(Combat c, Character target) {
        ...
        if (target.human()) {
            switch (Global.random(4)) {
                ...
                case 2:
                    if (!target.getOutfit().slotUnshreddable(ClothingSlot.top)) {
                        c.write(owner(), own()
                                        + "slime forms into a shape that's vaguely human and clearly female. Somehow it manages to look cute and innocent while still being an animated blob of slime. "
            ...
            switch (Global.random(4)) {
                ...
                case 2:
                    if (!target.getOutfit().slotUnshreddable(ClothingSlot.top)) {
                        c.write(owner(), "Your slime pounces on " + target.name()
    ...
    public void vanquish(Combat c, Pet opponent) {
        switch (opponent.type()) {
            case fairyfem:
                ...
                break;
            case fairymale:
                c.write(owner(), opponent.own() + "faerie flies too close to " + own()
                ...
                break;
            case impfem:
                c.write(owner(), own() + "slime gathers around " + opponent.own()
            ...
            case impmale:
                ...
                break;
            case slime:
                c.write(owner(), "The two slimes circle around each other, while gradually taking on human shape. One of the oozes looks vaguely like "
