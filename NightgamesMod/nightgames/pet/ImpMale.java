			...
			switch (Global.random(4)) {
				case 3:
					c.write(owner(),
							"Your imp masturbates frantically until he cums intensely. He aims his spurting cock at "
									+ target.name()
									+ ", hitting her in the face with a thick load "
				...
				case 2:
					if (target.crotchAvailable()
						...
						c.write(owner(), "Your imp latches onto "
								+ target.name()
						...
						c.write(owner(), own()
								+ "imps strokes himself while watching the fight.");
					}
					break;
				case 1:
	...
	public void vanquish(Combat c, Pet opponent) {
		switch (opponent.type()) {
			case fairyfem:
				...
				break;
			case fairymale:
				c.write(owner(), own() + "imp swats " + opponent.own()
						+ "faerie out of the air.");
				break;
			case impfem:
				c.write(owner(),
