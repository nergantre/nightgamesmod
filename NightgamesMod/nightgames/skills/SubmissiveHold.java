...
public class SubmissiveHold extends Skill {
	...
	public String deal(Combat c, int damage, Result modifier,
		...
		if (isArmLock(c.getStance())) {
			return Global.format(
					"You entwine {other:name-possessive} fingers with your own, holding her in position.",
					getSelf(), target);
		} else {
			return Global.format(
	...
	public String receive(Combat c, int damage, Result modifier,
		...
		if (isArmLock(c.getStance())) {
			return Global.format(
					"{self:SUBJECT} entwines your fingers with her own, holding you in position.",
					getSelf(), target);
		} else {
			return Global.format(
