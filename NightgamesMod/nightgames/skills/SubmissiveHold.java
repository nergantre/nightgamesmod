...
public class SubmissiveHold extends Skill {
	...
	public String deal(Combat c, int damage, Result modifier, Character target) {
		if (isArmLock(c.getStance())) {
			return Global.format("You entwine {other:name-possessive} fingers with your own, holding her in position.",
					getSelf(), target);
		} else {
			return Global.format(
					"You embrace {other:name} and wrap your legs around her waist, holding her inside you.", getSelf(),
					target);
		}
	}
