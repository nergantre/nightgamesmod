...
public class MimicCat extends Skill {
    ...
    public boolean resolve(Combat c, Character target) {
        ...
        getSelf().add(new Abuff(getSelf(), Attribute.Animism, Math.max(10, getSelf().get(Attribute.Slime)), 10));
        getSelf().add(new SlimeMimicry("werecat", PussyPart.feral, CockMod.primal, getSelf(), 10));
        return true;
    }
