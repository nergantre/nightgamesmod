...
public class LewdSuggestion extends Skill {
	...
	public String deal(Combat c, int damage, Result modifier,
		...
		if (modifier == Result.strong) {
		       return String.format("You take advantage of the erotic fantasies already swirling through %s's head, whispering ideas that fan the flame of %s lust.", new Object[] {
		         target.name(), target.possessivePronoun() });
		     }
		     return String.format("You plant an erotic suggestion in %s's mind, distracting %s with lewd fantasies.", new Object[] {
	...
	public String receive(Combat c, int damage, Result modifier,
			Character target) {
		if (modifier == Result.strong) {
		       return String.format("%s whispers a lewd suggestion to you, intensifying the fantasies you were trying to ignore and enflaming your arousal.", new Object[] {
		         getSelf().name() });
		     }
		     return String.format("%s gives you a hypnotic suggestion and your head is immediately filled with erotic possibilities.", new Object[] {
		       getSelf().name() });
	}
