...
public class Drain extends Skill {
	...
	public boolean resolve(Combat c, Character target, boolean nocost) {
		...
		int type = Math.max(1, Global.centeredrandom(6,
				getSelf().get(Attribute.Dark) / 3.0, 3));
	...
	public String deal(Combat c, int damage, Result modifier,
		...
		if (c.getStance().inserted(target)) {
			String muscDesc = c.getStance().anallyPenetrated(getSelf()) ? "anal"
					: "vaginal";
			...
			String base = "You put your powerful " + muscDesc
					+ " muscles to work whilst" + " transfixing "
					+ target.name() + "'s gaze with your own, goading "
					+ target.possessivePronoun() + " energy into "
					+ target.possessivePronoun() + " cock."
					+ " Soon it erupts from her into your " + partDesc + ", ";
			switch (damage) {
				case 4:
					return base + "and you can feel "
							+ target.possessivePronoun()
							+ " strength pumping into you.";
				case 3:
					return base + "and you can feel "
							+ target.possessivePronoun()
							+ " memories and experiences flow"
							+ " into you, adding to your skill.";
				case 5:
					return base + "taking " + target.possessivePronoun()
							+ " raw sexual energy and"
							+ " adding it to your own";
				case 1:
					return base
							+ "but unfortunately you made a mistake, and only feel a small"
							+ " bit of " + target.possessivePronoun()
							+ " energy traversing the space between you.";
				case 2:
					return base
							+ "but unfortunately you made a mistake, and only feel a small"
							+ " bit of " + target.possessivePronoun()
				...
				case 6:
					return base
							...
							+ " You feel a fragment of "
							+ target.possessivePronoun()
							+ " soul break away from her and"
							+ " gush into you, taking along a portion of "
							+ target.possessivePronoun() + " strength,"
			...
			switch (damage) {
				case 4:
					return base
							+ "You feel yourself grow stronger as you steal her physical power.";
				case 5:
					return base
							+ "You manage to steal some of her sexual experience and skill at seduction.";
				case 3:
					return base
							+ "You draw some of her wit and cunning into yourself.";
				case 1:
	...
	public String receive(Combat c, int damage, Result modifier,
		...
		if (c.getStance().inserted(target)) {
			...
			String base = "You feel " + getSelf().nameOrPossessivePronoun()
					+ " powerful " + muscDesc
					+ " muscles suddenly tighten around you. "
					...
					+ " something far more precious than semen into her "
					+ partDesc + "; as more of the ethereal"
			...
			switch (damage) {
				...
				case 3:
					return base
							+ "your mind go numb, causing your confidence and"
							+ "cunning to flow into her.";
				case 1:
					return "Clearly the succubus is trying to do something really special to you, "
							+ "as you can feel the walls of her " + partDesc
							+ " squirm against you in a way "
				...
				case 0:
					return getSelf().name() + " squeezes you with her "
							+ partDesc
							+ " and starts to milk you, but you suddenly feel her shudder and moan loudly. Looks like her plan backfired.";
				case 6:
					return base
			...
			String base = "You feel " + getSelf().nameOrPossessivePronoun()
					+ " powerful will drawing some of your energy into "
					+ getSelf().possessivePronoun() + " cock, ";
			switch (damage) {
				case 4:
					return base + "your strength leaving you with it, "
							+ "making you more tired than you have ever felt.";
				...
				case 1:
					return "Clearly the demon is trying to do something really special to you, "
							...
							+ " cock thrust against you in a way "
							+ "no human could manage, but all you feel is some drowsiness";
				case 2:
					return "Clearly the demon is trying to do something really special to you, "
							+ "as you can feel "
				...
				case 0:
					return getSelf().name()
							+ " draws upon your will through your connection, but you suddenly feel "
							+ getSelf().pronoun()
							+ " shudder and moan loudly. Looks like "
							+ getSelf().possessivePronoun()
							+ " plan backfired.";
				case 6:
					return base
							+ "something snap loose inside of you and it seems to flow right "
							+ "through your pussy and into "
							+ getSelf().directObject()
							+ ". When it is over you feel... empty "
							+ "somehow. At the same time, " + getSelf().name()
							+ " seems radiant, looking more powerful,"
							+ " smarter and even more seductive than before. Through all of this,"
							+ " " + getSelf().pronoun()
							+ " has kept on thrusting and you are right on the edge of climax."
							+ " Your defeat appears imminent, but you have already lost something"
							+ " far more valuable than a simple sex fight...";
				default:
					// Should never happen
