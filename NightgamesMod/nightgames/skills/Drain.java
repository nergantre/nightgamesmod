	...
	public String deal(Combat c, int damage, Result modifier, Character target) {
		if (c.getStance().inserted(target)) {
			...
			String base = "You put your powerful " + muscDesc + " muscles to work whilst" + " transfixing "
					+ target.name() + "'s gaze with your own, goading " + target.possessivePronoun() + " energy into "
					+ target.possessivePronoun() + " cock." + " Soon it erupts from her into your " + partDesc + ", ";
			switch (damage) {
			case 4:
	...
	public String receive(Combat c, int damage, Result modifier, Character target) {
		if (c.getStance().inserted(target)) {
			...
			String base = "You feel " + getSelf().nameOrPossessivePronoun()
					+ " powerful will drawing some of your energy into " + getSelf().possessivePronoun() + " cock, ";
			switch (damage) {
			case 4:
				return base + "your strength leaving you with it, " + "making you more tired than you have ever felt.";
			case 5:
			...
			case 0:
				return getSelf().name() + " draws upon your will through your connection, but you suddenly feel "
						+ getSelf().pronoun() + " shudder and moan loudly. Looks like " + getSelf().possessivePronoun()
						+ " plan backfired.";
			case 6:
				return base + "something snap loose inside of you and it seems to flow right "
						+ "through your pussy and into " + getSelf().directObject()
						+ ". When it is over you feel... empty " + "somehow. At the same time, " + getSelf().name()
