...
public class InjectOtherAntidote extends Skill {
	...
	public String deal(Combat c, int damage, Result modifier, Character target) {
		return Global.format("Moving quickly you inject {other:name-do} with an antidote, removing any buffs or debuffs {other:possessive} had.",
				getSelf(), target);
	}

	public String receive(Combat c, int damage, Result modifier, Character target) {
		return Global.format("{self:SUBJECT} quickly manages to stick you with a hypodermic needle. As the contents flood into your body, you feel any temporary buffs or debuffs leave you.",
				getSelf(), target);
	}
