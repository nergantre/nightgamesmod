...
public class AngelTime extends BaseNPCTime {
	...
	public void buildTransformationPool() {
		...
		}
		{
			...
			// WARNING this is using the players current divinity. If this changes to work on other NPCs, it will fail.
		...
		if(choice == "Sex"){
			...
			if(npc.getAffection(player)>=8&&(!player.has(Trait.pokerface)||Global.random(2)==1)){
				Global.gui().message("Today all the girls left the responsibility of choosing a game to you, with Angel's stipulation that it had to including stripping. You picked a simple, but intense " +
						...
						"smile. Mei and Sarah are both watching rapt, each with one hand under the table. <i>\""+player.name()+" isn't the only loser in the room,\"</i> Caroline says while glancing at the naked girls. <i>\"How about " +
				...
				Global.gui().message("You know this can't end well for you. When you suggested playing a game, all of the girls shared a conspiratorial smile and Angel declared she had a game in mind. " +
						...
						"means Angel and "+player.name()+" are out. Caroline wins!\"</i> <p>There was definitely no mention of a bonus for grabbing your cock during the rules explanation. Caroline's response to " +
