...
public class AngelTime extends BaseNPCTime {
    ...
    public void subVisitIntro(String choice) {
        if (npc.getAffection(player) > 0) {
            Global.gui().message(
                            "You text Angel, suggesting to meet up. She responds with a location where to meet her. When you arrive however, you find her friends waiting "
                                            ...
                                            + "to make a quick phone call. On her way out, she slips a small piece of paper into your hand with a flirtatious smile. It turns out to contain her phone number.<p><i>\"Be "
            ...
            Global.gui().message(
                            "While walking through the quad, you spot Angel talking with three other girls. They're too far away to hear what they are talking about, but "
            ...
            Global.gui().message(
                            "Using the information you got from Aesop, you go looking for Angel. Your hope is to invite her to spend time training together and possibly sex. "
                                            ...
                                            + "catch and walks over to you.<p><i>\"Did you want to talk to me or were you just planning to stare?\"</i> Her words are harsh, but her tone is light enough that you can "
            ...
            if (npc.getAffection(player) >= 12 && (!player.has(Trait.experttongue) || Global.random(2) == 1)) {
                Global.gui().message(
                                "You're in Angel's room, naked and feeling a little overwhelmed. She embraces your from behind and you can feel her soft, heavy breasts pressed against "
                                                ...
                                                + "need a volunteer,\"</i> she eventually declared.<p>So that's how the three of you ended up here. Mei modestly keeps her hands in front of her groin, but doesn't show any indication "
                                                ...
                                                + "the kiss drives all conscious thought from your head. When she pulls away and you regain your senses, you're so aroused that precum is dripping from your erection.<p>Angel pushes you "
                                                ...
                                                + "she pulls away from you abruptly, flushed deep red and panting for breath. <i>\"Ok, that's enough,\"</i> she gasps out. <i>\"You win.\"</i> So she came already? Mei nods, avoiding eye contact.<p>"
                                                ...
                                                + "she's recovering, Angel slips the other ice cube into Mei's mouth and straddles her face. \"If this is punishment then you shouldn't have all the fun. Give me some attention this time.\"<p>"
                ...
                if (!player.has(Trait.experttongue)) {
                    Global.gui().message(
                                    "<p><b>You've improved your kissing technique to the point where it may render opponents temporarily helpless.</b>");
                    player.add(Trait.experttongue);
                    npc.add(Trait.experttongue);
                }
            } else {
                Global.gui().message(
                                "You suggest to Angel that maybe the two of you should head somewhere a bit more private. You barely finish the sentence before she grabs you by the arm and "
            ...
            if (npc.getAffection(player) >= 8 && (!player.has(Trait.pokerface) || Global.random(2) == 1)) {
                Global.gui().message(
                                "Today all the girls left the responsibility of choosing a game to you, with Angel's stipulation that it had to including stripping. You picked a simple, but intense "
                                                ...
                                                + "her bra and panties.<p>The next round is almost certainly going to be your or Angel's last and you're determined not to go down without a fight. All the coasters are played this round and "
                ...
                Global.gui().message(
                                "You know this can't end well for you. When you suggested playing a game, all of the girls shared a conspiratorial smile and Angel declared she had a game in mind. "
                                                ...
                                                + "<p>About ten minutes and some lost clothing later and Sarah starts calling some weird commands. <i>\"Right hand free.\"</i> Free? What exactly does that mean? <i>\"It means you can move "
                                                ...
                                                + "and falls down onto you. There go her pants, and yours.<p>A few more minutes and you end up reaching over Caroline to get a green circle, which is slightly awkward since she's "
                                                ...
                                                + " are out. Caroline wins!\"</i> <p>There was definitely no mention of a bonus for grabbing your cock during the rules explanation. Caroline's response to "
            ...
            if (npc.getAffection(player) >= 16 && (!player.has(Trait.disciplinarian) || Global.random(2) == 1)) {
                Global.gui().message(
                                "Your strip wrestling with Angel has become a routine secondary version of your nightly competitions. Unfortunately, in this venue, Angel has a a much better "
                                                ...
                                                + "show.<p>This match seems pretty par for the course. You've managed to get Angel to her bra and panties (that's good), but you're down to just your boxers (that's bad). It's "
                                                ...
                                                + "the mat. You manage to secure her panties and you try to get her bra, but she kicks at you and forces you back.<p>The match is still on, but you clearly came out on top in that "
                                                ...
                                                + "behind. You manage to undo her bra and pull it off despite her thrashing. Angel finally manages to calm down to a quiet seethe with the realization that she's lost.<p>It occurs to you "
                                                ...
                                                + "hide anything from themMM!... or you. I-I want the people I love to see everything about me. Even-AH! this!\"</i><p>You feel Angel tense up in you arms and a flood of love juice hits your "
                ...
                if (!player.has(Trait.disciplinarian)) {
                    Global.gui().message(
                                    "<p><b>You've learn how to spank your opponent in a way that can ruin their morale.</b>");
                    player.add(Trait.disciplinarian);
                    npc.add(Trait.disciplinarian);
                }
            } else {
                Global.gui().message(
                                "You and Angel borrow a small fitness room and some wrestling mats for some sparring practice. She suggests clothing removal as the victory condition instead of "
