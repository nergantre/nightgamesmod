...
public class Threesomes implements Scene {
    ...
    public void visit(String choice) {
        ...
        if (choice.equals("CassieJewel")) {
            Global.gui().message(
                            "You step out of the shower room with a towel wrapped around your waist to preserve your modesty. One of these days you should get a proper bathrobe, "
        ...
        if (choice.equals("CassieAngel")) {
            Global.gui().message("");
        }
        if (choice.equals("MaraJewel")) {
            Global.gui().message(
                            "You're sitting in your room, working on some homework, when you hear a knock on your door. You open the door to find Mara, who pushes past you into "
        ...
        if (choice.equals("CassieMara")) {
            Global.gui().message("");
        }
        if (choice.equals("AngelMara")) {
