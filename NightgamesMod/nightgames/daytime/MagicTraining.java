	...
	public void visit(String choice) {
		...
		if (!Global.checkFlag(Flag.metAisha)) {
			...
			if (player.money >= 500 + 500 * (player.getPure(Attribute.Animism) + 1)) {
				...
				Global.gui()
						.message("Kat comes in again to help you practice tapping "
			...
			Global.gui().message("You bring up the topic of Kat's animal spirit and "
					...
					+ " to you alone. If you really want this power, you'll probably " + "need to rely on Kat's help.");
			...
			Global.gui().message("Kat agrees to come to the creative writing reference"
					...
					+ "many wonderful things. I'm so grateful for what you've done for me. If" + " spirit magic gives "
					+ player.name() + " even half as much happiness as it's given me, I'm "
