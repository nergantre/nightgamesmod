...
public class Aggressive extends DurationStatus {
	...
	private static final Collection<Skill> CONTACT_SKILLS = Collections
			.unmodifiableSet(Global.getSkillPool().stream().filter(Skill::makesContact).collect(Collectors.toSet()));
