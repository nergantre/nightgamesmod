...
public class Airi extends BasePersonality {
	...
	public Airi(){
		...
		this.character.set(Attribute.Seduction, 15);
		this.character.getStamina().setMax(50);
		this.character.getArousal().setMax(80);
	...
	public String victory3p(Combat c, Character target, Character assist) {
		if (target.human()) {
			...
			return "Airi flows over to " + target.name() + ". Her slime pools into a long and flexible appendage and worms itself inside " + target.possessivePronoun()+ " depths. The appendage starts to twist and squirm inside her poor victim and almost instantly causes her victim to scream out in pleasure.<br><br>";
		}
	}
	...
	public String intervene3p(Combat c, Character target, Character assist) {
		if(target.human()){
			return Global.format("Your fight with {other:name} seemed to have ran into a stalemate. Neither of you is willing to get close enough to each other for anything substantial to happen. You just continue to trade taunt while waiting for an opportunity.<br><br>"
						+ "Suddenly, you feel something grasp your ankles and pull you off balance. You brace yourself for the fall, but after a second, you only feel softness on your back. It’s Airi. She somehow snuck up on you and tripped you into falling on top of her. She quickly engulfs your hands and legs in her slime and presents your helpless body to {other:name}’s ministrations.", character, assist);
		}
		else{
			return Global.format("Your fight with {other:name} seemed to have ran into a stalemate. Neither of you is willing to get close enough to each other for anything substantial to happen. You just continue to trade taunt while waiting for an opportunity."
						+"Suddenly, a blue blob appears in your line of sight. It’s Airi! More swiftly than you would expect, Airi moves to {other:name}’s side and engulfs her body in her own. After dissolving her clothing with her slime, Airi surfaces only {other:name-possessive} torso and sex, presenting her to you. Well, presented with a gift on a silver platter, you’re not going to refuse!", character, target);
		}
	}
	@Override
