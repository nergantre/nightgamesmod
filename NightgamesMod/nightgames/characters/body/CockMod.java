...
public enum CockMod implements BodyPartMod {
	error(1.0, 1.0, 1.0), slimy(.5, 1.5, .7), runic(2.0, 1.0, 1.0), blessed(1.0, 1.0, .75), incubus(1.25, 1.3,
			.9), primal(1.0, 1.4, 1.2), bionic(.8, 1.3, .5), enlightened(1.0, 1.2, .8);
	...
	public void onEndPenetration(Combat c, Character self, Character opponent, BodyPart target,
		...
		if (this == slimy) {
			c.write(self, Global.format(
					"As {self:possessive} {self:body-part:cock} leaves {other:possessive} " + target.describe(opponent)
