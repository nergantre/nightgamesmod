...
public class StatUtil {
    ...
    private static final double ICDF_A[] = {-3.969683028665376e+01, 2.209460984245205e+02, -2.759285104469687e+02,
                    1.383577518672690e+02, -3.066479806614716e+01, 2.506628277459239e+00};

    private static final double ICDF_B[] = {-5.447609879822406e+01, 1.615858368580409e+02, -1.556989798598866e+02,
                    6.680131188771972e+01, -1.328068155288572e+01};

    private static final double ICDF_C[] = {-7.784894002430293e-03, -3.223964580411365e-01, -2.400758277161838e+00,
    ...
    public static double getInvCDF(double d, boolean highPrecision) {
        ...
        // Rational approximation for central region:
            ...
            z = (((((ICDF_A[0] * r + ICDF_A[1]) * r + ICDF_A[2]) * r + ICDF_A[3]) * r + ICDF_A[4]) * r + ICDF_A[5]) * q
                            / (((((ICDF_B[0] * r + ICDF_B[1]) * r + ICDF_B[2]) * r + ICDF_B[3]) * r + ICDF_B[4]) * r
                                            + 1);
        }
        if (highPrecision) {
            z = refine(z, d);
    ...
    private static final double ERF_Q[] = {2.56852019228982242E00, 1.87295284992346047E00, 5.27905102951428412E-1,
    ...
    /*
     * **************************************************** Refining algorytm is based on Halley rational method for finding roots of equations as described at: http://www.math.uio.no/~jacklam/notes/invnorm/index.html by: Peter John Acklam jacklam@math.uio.no **************************************************
     */
