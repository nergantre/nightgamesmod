	...
	public void trigger(Character target) {
		if(target.nude()){
			if(target.human()){
				...
				Global.gui().message(target.name()+" gets caught in the tentacle trap and is immediately surrounded by penis-shaped tentacles. Before she can escape, they bind her " +
			...
			if(target.human()){
				Global.gui().message("Holy hell! A dozen large tentacles shoot out of the floor in front of you and thrash wildly. You freeze, hoping they won't notice you, but " +
