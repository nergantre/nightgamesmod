...
public class Spiderweb implements Trap {
	...
	public void trigger(Character target) {
		if(target.human()){
			...
			Global.gui().message("You hear a snap as "+target.name()+" triggers your spiderweb trap and ends up helplessly suspended in midair like a naked present.");
		}
	...
	public void capitalize(Character attacker, Character victim, Encounter enc) {
		if(attacker.human()){
			Global.gui().message(victim.name()+" is naked and helpless in the giant rope web. You approach slowly, taking in the lovely view of her body. You trail your fingers " +
