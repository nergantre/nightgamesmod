...
public class MagicTraining extends Activity{
	...
	public void visit(String choice) {
		...
		if(!Global.checkFlag(Flag.metAisha)){
			Global.gui().message("Aisha apparently spends most of her time in a mostly abandoned creative writing reference room in the back of the liberal arts building. On paper, she " +
					...
					"gives you a gentle, charming smile. <i>\"Hello "+player.name()+". I know who you are of course. The videos of your fights have been fascinating.\"</i> That catches you off " +
			...
			if(player.money>=1000*(player.getPure(Attribute.Arcane)+1)){
				...
				switch(scene){
				case 0:
					Global.gui().message("Aisha nods and waves her hand through the air. As she does so, you feel the world around you shift and a huge wave of nausea " +
					...
					break;
				case 1:
					Global.gui().message("After you give Aisha the money she asked for she once again brings both of you to the same training room you were in before except " +
					...
					break;
				case 2:
					Global.gui().message("Aisha grins and as per usual you find yourself in the training room, this time there's a bunch of mannequins with random assortments of " +
					...
					break;
				default:
					Global.gui().message("Aisha pauses and closes her eyes briefly before grinning and bringing you both to the training room. This time Aisha arrives before you... All four of " +
