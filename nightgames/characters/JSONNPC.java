...
import nightgames.items.ConditionalEffect;
...
public class JSONNPC extends BasePersonality {
	/**
	 * 
	 */
	...
	public void setGrowth() {
		...
		growth.traits.put(9, Trait.pussyTraining1);
		growth.traits.put(12, Trait.expertGoogler);
		growth.traits.put(15, Trait.experienced);
		growth.traits.put(18, Trait.spiritphage);
		growth.traits.put(20, Trait.skeptical);
		growth.traits.put(21, Trait.holecontrol);
		growth.traits.put(24, Trait.pussyTraining2);
		growth.traits.put(27, Trait.lacedjuices);
		growth.traits.put(30, Trait.magicEyeArousal);
		growth.traits.put(33, Trait.energydrain);
		growth.traits.put(36, Trait.RawSexuality);
		growth.traits.put(39, Trait.tight);
		growth.traits.put(42, Trait.desensitized);
		growth.traits.put(45, Trait.entrallingjuices);
	...
	public String victory(Combat c,Result flag) {
		...
		if(flag==Result.anal && c.getStance().inserted(character)){
			...
			message = "Angel stares at you in the eye, while expertly thrusting in and out of your slobbering pussy. Your needy cunt quivers as she leans close and gives you a long steamy kiss, tongue and all. You try to get away from her, but she holds you down and merciless pounds away at your overused pussy. You can tell she?fs turned on as well, but it?fll do you no good, as you?fre already feeling yourself slip over the edge. "
					+ "<br><br>Finally it becomes too much, and you cum hard. You wrap your arms and legs unconsciously cling to Angel?fs body and you seek out a needy kiss from her. Angel takes note of your convulsing body, and smirks, <i>?hI think you need some more training. I could make anyone cum instantly while they?fre in me.?h</i> After a small pausing, Angel grins devilishly and resumes pumping in and out of pussy in long leisurely strokes. <i>?hHmm?c in fact, why don?ft I practice with you a bit? You know what they say, practice makes perfect!?h You groan in frustration as your oversensitive cunt receives her cocks again. "
