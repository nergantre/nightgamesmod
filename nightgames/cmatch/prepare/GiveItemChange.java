...
/**
 * Change to ensure a character holds at least X copies of an item.
 */
public class GiveItemChange implements PrematchChange {

	private Item item;
	private int count;
	private int startCount;
	
	public GiveItemChange(Item item, int count) {
		this.item = item;
		this.count = count;
	}
	...
	public PrematchChange copy() {
		return new GiveItemChange(item, count);
	}
