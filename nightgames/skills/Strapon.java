	...
	public boolean resolve(Combat c, Character target) {
		...
		if (unequipped.isEmpty()) {
			...
			if(getSelf().human()){
				...
				c.write(getSelf(),target.subject() + " takes off " + target.possessivePronoun() + " " + unequipped.get(0) + " and straps on a thick rubber cock and grins at you in a way that makes you feel a bit nervous.");
			}
		}
